...
\def\email{xxx@xxx.edu}
\def\LinkedIn{xxx} % linkedin.com/in/______
\def\github{xxx} % github username
%\def\role{Intern Software Engineer} % JOB TITLE

%====================
% Company Info
%====================
\def\hm{xx} % Hiring Manager Name, leave empty if unknown
